...
const StatusPage = () => {
  ...
  const handleHeaderAddClick = () => {
    // On status page, the + button just sends you to the main Vigil dashboard
    navigate("/");
  };
    ...
    return (
      <div className="min-h-screen bg-background">
        <div className="max-w-7xl mx-auto">
          <DashboardHeader onAddApplication={handleHeaderAddClick} />
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto">
        {/* 🔹 Same header & styling as dashboard (GLB + + button) */}
        <DashboardHeader onAddApplication={handleHeaderAddClick} />

        {/* Main content aligned with dashboard padding */}
        <main className="px-4 sm:px-6 lg:px-8 py-6 space-y-8">
          ...
          <header className="space-y-2">
            ...
            <p className="text-sm md:text-base text-muted-foreground">
              Live view of core internal applications. This page is read-only
              and does not expose admin controls.
            </p>
          </header>
              ...
              <div className="space-y-3">
                {apps.map((app) => {
                  ...
                  return (
                    <Card
                      key={app.id}
                      className="border border-card-border/70 card-hover"
                    >
